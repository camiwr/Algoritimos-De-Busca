...
public class BuscasNaoInformadas implements Busca {
    ...
    // Busca de Custo uniforme inferno
    private List<No> buscaCustoUniforme(No inicial, No objetivo) {
        
        throw new UnsupportedOperationException("Unimplemented method 'buscaCustoUniforme'");
    }
